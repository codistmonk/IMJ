...
public abstract class Patch2DSource extends DataSource.Abstract<DataSource> {
	...
	public final int sizeX() {
		return newSize(this.getBounds().x, this.getBounds().width, this.getStride());
	}
	
	public final int sizeY() {
		return newSize(this.getBounds().y, this.getBounds().height, this.getStride());
	}
	...
	public static final int newSize(final int boundary, final int size, final int stride) {
